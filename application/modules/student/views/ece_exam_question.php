<?php 
	$gte_questions = $this->Exam_model->get_question_ece($phase_level, $question_type, $limit);

	/*print_r($gte_questions);exit;*/
?>
					...
					<div class="slide-inner">
						<ul class="slide-area"> 
							<li>
								...
								?>
								<div class="question">
									<p>Mark: <?php if($question['ece_type'] == 1){
										echo '2.5';
									}else{ echo '1'; } ?></p>
									...
									<?php if (!empty($question['question_image'])) {?>
										<div style="width: 400px !important; margin:0px auto"><img src="<?php echo $question['question_image'];?>"></div>
									<?php } ?>
								</div>
								<?php
									$sl_number++;
