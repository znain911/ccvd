...
<div class="form-field-content">
	...
	<fieldset>
		...
		<div class="form-group row">
		  <label for="" class="col-md-2 control-label">CCVD batch</label>
		  <div class="col-md-4">
			<!-- <input type="text" name="number" class="form-control" placeholder="Enter batch name"> -->
			<select class="spoecial-aff-mostak" name="batch_name" id="batch_name">
				<?php 
					$get_batch_name = $this->Registration_model->get_batch_name();
					foreach($get_batch_name as $batch){
				?>
