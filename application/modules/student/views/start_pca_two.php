			...
			<div class="container">
				<div class="col-lg-12">
					<div class="content-text-goes">
						<h4 class="cnt-title">
							Notice for CCA 2 Exams
						</h4>
						<p class="cnt-para">
							<strong>IT IS IMPORTANT TO READ THE NOTICE BEFORE YOU PRESS “START”</strong> <br /><br />
							The <strong>CCA-2 EXAM</strong> is an <strong>ONLINE BASED EXAM</strong> that is <strong>TIME RESTRICTED</strong>. The TIME shall be restricted from <strong>4:00pm to 5:00pm</strong>. You must select Start Exam at the bottom of the screen to start the Online CCA-2 Exam. <br />
For students who enter late, the CCVD Course Administration is not liable for late entry. The Online CCA-2 Exam shall finish at 5:00pm.<br />
...
Please Do Not Refresh in the web browser during the Online CCA-2 Exam.<br /> 
Please Do Not Select Cancel because this will end Online CCA-2 Exam.<br /> 
...
The Exam is total 100 marks. You are required to obtain 60% of the total marks to pass the exam.
You are required to pass the Online CCA-2 Exam in order to move to Chapter 2. <br /> 
At the end of the Online CCA-2 Exam you shall receive your exam results by SMS and Email. <br /> 
<br /> Good Luck!
						</p>
						<div class="start-exanchor text-center">
						<?php $acdata = $this->Exam_model->getExamStatus();
								if($acdata->mrkconfig_exam_active == 1){?>
															<a href="<?php echo base_url('student/exam/index/PCA-2/Phase-B/START'); ?>" class="exstart-btn">Start Exam</a>
															<?php }else{
