<?php 
	$sdt_schedule_info = $this->Course_model->get_workshopscheulde_info($schdle_id, $phase_lavel);
?>
	...
	<div class="end-module-exam booking-frm-sdt">
		<div class="starter-module-exam-start">
			...
			<div class="form-group row">
				...
				<div class="col-lg-4">
					<select name="center" id="workshopCenterDetails" class="form-control">
						<option value="">Select Center Location</option>
						<?php  
							$get_centerschedules = $this->Course_model->get_workshop_centerschedules($sdt_schedule_info['endmschedule_id']);
		...
		<div class="result-table">
			...
			<table class="table">
				...
				<tbody id="bookingContent">
					<?php require_once APPPATH.'modules/student/views/bookings/all_workshop_bookings.php' ?>
				</tbody>
			</table>
		</div>
	</div>
