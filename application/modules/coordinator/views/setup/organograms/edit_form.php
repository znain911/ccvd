...
<div class="form-cntnt form-number-<?php echo $id; ?>">
	...
	?>
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				<select name="type" class="form-control valid">
					<option value="<?php echo $row_info['owner_type']; ?>"><?php echo $row_info['owner_type']; ?></option>
					...
					<option value="Faculties">National Faculties</option>
		...
		<div class="form-group">
			<label class="col-md-8 control-label">Designation 2</label>
			<div class="col-md-4">
				<input type="text" name="designation2" placeholder="Enter Designation" class="form-control" value="<?php echo $row_info['owner_designation2']; ?>">
			</div>
		</div>
		<div class="form-group">
