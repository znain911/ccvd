<?php 
	$row_info = $this->Notice_model->get_info($id);
?>
	...
	?>
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				...
				<div class="old-photo">
					<!-- <img src="<?php echo attachment_url('notice/'.$row_info['filename']); ?>" alt="Photo" /> -->
					<a href="<?php echo attachment_url('notice/'.$row_info['filename']); ?>" target="_blank">Click here to see old file</a>
				</div>
				<?php endif; ?>
