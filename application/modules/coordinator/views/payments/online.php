		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				/*$(document).on('click', '#exportpdf', function(){
					var bid = $('#batch').val();
					window.location.href = baseUrl+'coordinator/payments/online_detail_csv/'+bid;					
				});*/
			});
