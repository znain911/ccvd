<?php require_once APPPATH.'modules/coordinator/templates/header.php'; ?>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li><a href="javascript:;">Students Waiting List</a></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Student Waiting : <span id="totalEnrolledStudents"><?php echo count($get_items) ?></span></h1>
			<a href="<?php echo base_url('coordinator/students/waiting_csv');?>" class="btn btn-info pull-right"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Export</a>
			<!-- end page-header -->
		...
		<script type="text/javascript">
			...
			function searchFilter(page_num) {
				...
				$.ajax({
					type: 'POST',
					url: '<?php echo base_url(); ?>studentfilter/get_waiting_student/'+page_num,
