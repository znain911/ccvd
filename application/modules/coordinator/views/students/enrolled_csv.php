...
header("Content-disposition: attachment; filename=enrolled_students".$batchname.".xls");
?>

<table border="1">
	<thead>
		<tr>
			<th class="text-center" style="font-size: 26px; padding: 15px 0px" colspan="29">IBRAHIM CARDIAC HOSPITAL & RESEARCH INSTITUTE</th>
		</tr>
		<tr>
			<th class="text-center" style="font-size: 16px" colspan="29">122, Kazi Nazrul Islam Avenue, Shahbag, Dhaka &#8208; 1000, Bangladesh</th>
		</tr>
		<tr>
			<th class="text-center" style="font-size: 22px" colspan="29">CCVDE-DLP</th>
		</tr>
		<tr>
			<th class="text-center" style="font-size: 20px" colspan="29">Enrolled Status of <?php echo $batchname; ?> Batch</th>
		</tr>
		<tr  border="0">
			<th class="text-center" style="font-size: 20px; text-align: left;" colspan="29">Total Applicants = <?php echo count($get_items);?></th>
		</tr>
		<tr>
			<th nowrap>SL</th>
			<th nowrap>ID</th>
