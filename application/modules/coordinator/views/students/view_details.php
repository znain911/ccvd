					...
					<div class="panel-body">
						<table class="table">
							...
							<tr style="background:#F9F9F9">
								...
								<td>
									<img src="<?php echo attachment_url('students/'.$item['spinfo_photo']); ?>" width="40" alt="" />
								</td>
							</tr>
							<tr style="background:#F9F9F9">
					...
					<div class="panel-body">
						<table class="table">
							...
							<tr style="background:#F9F9F9">
								...
								<td><a href="<?php echo base_url('attachments/students/'.$item['spsinfo_bmanddc_certificate']); ?>" target="_blank">View Certificate</a>
								<!-- <a href="<?php echo base_url('coordinator/students/certificate_download/').$item['student_id'].'/'.$item['student_entryid'];?>" class="btn btn-info btn-rounded btn-xs p-l-10 p-r-10">Download Certificate</a> -->
								</td>
							</tr>
							<tr style="background:#F9F9F9">
					...
					<div class="panel-body">
						<table class="table">
							...
							<tr style="background:#F9F9F9">
								...
								<td><a href="<?php echo base_url('attachments/students/'.$academic['sacinfo_certificate']); ?>" target="_blank">View Certificate</a></td>
							</tr>
							<?php } ?>
						</table>
					</div>
