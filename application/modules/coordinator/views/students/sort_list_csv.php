...
header("Content-disposition: attachment; filename=CCVD_sort_students".$batchname.".xls");
?>
...
<table border="1">
	<thead>
		...
		<tr>
			<th class="text-center" style="font-size: 20px" colspan="23">Applicant Short List for <?php echo $batchname; ?> Batch</th>
		</tr>
		<tr  border="0">
