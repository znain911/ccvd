<?php 
	$schedule_info = $this->Eceschedule_model->get_schedule_info($schedule_id);
?>
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				<select name="exam_type" class="form-control">
					...
					?>
						<option value="<?php echo $exarray_key; ?>" <?php echo ($schedule_info['endmschedule_exam_type'] == $exarray_key)? 'selected' : null; ?>><?php echo $exarray_value; ?></option>
					<?php
						endforeach;
					?>
				</select>
