...
<div id="onPgaeLoadingForm">
	<?php require_once APPPATH.'modules/coordinator/views/questions/ece/create_form.php'; ?>
</div>
			...
			<table class="table table-td-valign-middle m-b-0">
				...
				<tbody class="appnd-not-fnd-row">
					<?php
						...
						$config["base_url"] = base_url('coordinator/questions/ece'.'?prm=true'.$url_param);
						$config["total_rows"] = $this->Questions_model->count_ece_questions($src, $phaseLevel, $questionType);
						...
						$get_items = $this->Questions_model->get_ece_questions($src, $sorting, $sortType, $phaseLevel, $questionType, intval($page), $config["per_page"]);
