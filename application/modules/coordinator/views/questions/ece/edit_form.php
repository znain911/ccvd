...
<div class="form-cntnt form-number-<?php echo $id; ?>">
	...
	?>
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				<textarea placeholder="Write the question here" rows="5" cols="30" class="form-control" name="title"><?php echo $row_info['question_title']; ?></textarea>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label class="col-md-8 control-label">Image Link</label>
			<div class="col-md-4">
				<!-- <input type="file" name="recent_photo"> -->
				<input type="text" name="recent_photo" class="form-control" value="<?php echo $row_info['question_image'];?>">
			</div>
		</div>
