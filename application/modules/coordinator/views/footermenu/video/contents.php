...
<div id="onPgaeLoadingForm">
	<?php require_once APPPATH.'modules/coordinator/views/footermenu/menu/create_form.php'; ?>
</div>
		...
		<div id="getContents">
			<table id="data-table" class="table table-td-valign-middle m-b-0">
				...
				<tbody class="appnd-not-fnd-row">
					<?php
					$get_items = $this->Footermenu_menu_model->get_all_videolink();
					...
					<tr class="cnt-row items-row-<?php echo $item['id']; ?>">
						...
						<td class="text-center"><iframe width="150" height="100"
src="<?php echo $item['link']; ?>">
</iframe></td>
						<td class="text-center">
