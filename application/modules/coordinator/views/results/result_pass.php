...
header("Content-disposition: attachment; filename=Pass_result_"
...
<table border="1">
				<thead>
					...
					<tr>
						<th class="text-center" style="font-size: 20px" colspan="11">Batch-<?php echo $batchname; ?> <?php echo $etyp; ?> Exam Passed Students Report </th>
					</tr>
