			...
			<table id="data-table" class="table table-td-valign-middle m-b-0">
				...
				<tbody class="appnd-not-fnd-row">
					...
					<tr class="cnt-row items-row-<?php echo $item['cmreport_id']; ?>">
						...
						<td class="text-center">
						<?php 
								if($item['phase_name']=="ECE"):?>
									<a href="<?php echo base_url('coordinator/results/detailresultece/').$item['cmreport_student_id'].'/'.$item['cmreport_phase_id']; ?>" class="btn btn-info btn-xs p-l-10 p-r-10" target="_blank">View Deteil</a>
									<?php else: ?>
									<a href="<?php echo base_url('coordinator/results/detailresult/').$item['cmreport_student_id'].'/'.$item['cmreport_phase_id']; ?>" class="btn btn-info btn-xs p-l-10 p-r-10" target="_blank">View Deteil</a>
									<?php endif; ?>
