...
<?php  
	...
	$personal_info = $this->Registration_model->get_personal_info($teacher_id);
?>
	...
	<div class="row reg-flow-input-mrg">
		<div class="col-lg-4">
			...
			<?php if($personal_info['tpinfo_photo']): ?>
			  <div class="old-img"><img src="<?php echo attachment_url('faculties/'.$this->session->userdata('wizard_username_teacher').'/'.$personal_info['tpinfo_photo']); ?>" style="height:50px;width:65px" alt="Recent Photo" /></div>
			<?php endif; ?>
