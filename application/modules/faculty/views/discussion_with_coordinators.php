				...
				<div class="col-lg-12 text-right">
					<div class="navigate-to-discuss">
						<div class="btn-group btn-group-justified btn-group-raised">
							<a class="btn <?php echo active_chat_link('with', 'Students'); ?>" href="<?php echo base_url('faculty/discussion?with=Students'); ?>">DISCUSSION WITH STUDENTS<div class="ripple-container"></div></a>
							<a class="btn <?php echo active_chat_link('with', 'Coordinators', true); ?>" href="<?php echo base_url('faculty/discussion?with=Coordinators'); ?>">DISCUSSION WITH COORDINATOR</a>
						</div>
					</div>
				</div>
			</div>
