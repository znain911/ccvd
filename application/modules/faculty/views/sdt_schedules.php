			...
			<div class="row">
				...
				<div class="col-lg-9 myac-container">
					...
					<div class="result-table">
						...
						<p class="result-tbl-head"><strong>Available SDT Schedules</strong></p>
						<table class="table" style="font-size:12px;">
							...
							<tbody id="sessionContent">
								<?php require_once APPPATH.'modules/faculty/views/sdt/all_sessions.php' ?>
							</tbody>
						</table>
					</div>
					...
					<br />
					<div class="result-table">
						<p class="result-tbl-head"><strong>Applied SDT Schedules</strong></p>
						<table class="table" style="font-size:12px;">
							<thead>
								<tr>
							...
							<tbody id="bookingContent">
								<?php require_once APPPATH.'modules/faculty/views/sdt/all_bookings.php' ?>
							</tbody>
						</table>
					</div>
					...
					<br />
					<div class="result-table">
						<p class="result-tbl-head"><strong>My SDT Programmes</strong></p>
						<table class="table" style="font-size:12px;">
							<thead>
								<tr>
									<th class="text-left">Application ID</th>
							...
							<tbody>
								<?php require_once APPPATH.'modules/faculty/views/sdt/my_programmes.php' ?>
							</tbody>
						</table>
					</div>
				</div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			$(document).on('click', '.session-row', function(){
				...
				$.ajax({
					type : "POST",
					url : baseUrl + "faculty/booking/sdt_frmsubmission",
						...
						if(data.status == "ok")
						{
							...
							$("#ftwofBooking").validate({
								...
								submitHandler : function () {
									...
									$.ajax({
										type : "POST",
										url : baseUrl + "faculty/booking/sdt",
