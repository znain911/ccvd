<?php 
	$programmes = $this->Course_model->my_workshop_programmes();
...
<tr>
	...
	<td class="text-center">
		<a href="<?php echo base_url('faculty/schedules/workshopmarks/?gt_cntr='.$programme['centerschdl_id'].'&sdl='.$programme['centerschdl_parentschdl_id'].'&TYPE=workshop-sess'); ?>"><span class="upmrks">Upload Marks</span></a>
	</td>
</tr>
<?php endforeach; ?>