<?php  
	$get_bookings = $this->Course_model->get_ece_booked();
	foreach($get_bookings as $booking):
	$get_center_details = $this->Course_model->get_ececenter_location($booking['booking_schedule_centerid']);
	$booking_status = $this->Course_model->check_ecebooking_status($booking['booking_id']);
?>
<tr>
	<td class="text-left"><?php echo $booking['booking_application_id']; ?></td>
