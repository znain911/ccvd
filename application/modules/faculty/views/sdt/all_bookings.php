<?php  
	$get_bookings = $this->Course_model->get_sdt_booked();
	foreach($get_bookings as $booking):
	$get_center_details = $this->Course_model->get_sdtcenter_location($booking['booking_schedule_centerid']);
	$booking_status = $this->Course_model->check_sdtbooking_status($booking['booking_id']);
?>
<tr>
